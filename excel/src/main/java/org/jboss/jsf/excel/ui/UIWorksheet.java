...
@FacesComponent( 
		...
		value="org.jboss.jsf.excel.ui.UIWorksheet")
public class UIWorksheet extends ExcelComponent
{
   public static final String COMPONENT_TYPE = "org.jboss.jsf.excel.ui.UIWorksheet";
   ...
   public static Iterator unwrapIterator(Object value)
   {
      ...
      {
         throw new ExcelWorkbookException("A worksheet's value must be an Iterable, DataModel.");
      }
   }
