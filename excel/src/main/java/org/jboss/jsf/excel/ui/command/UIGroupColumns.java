...
@FacesComponent(
		createTag=true,
		tagName="group-columns",
		namespace="http://jboss.org/jsf/excel",
		value="org.jboss.jsf.excel.ui.command.UIGroupColumns")
public class UIGroupColumns extends ExcelComponent implements Command
{
   public static final String COMPONENT_TYPE = "org.jboss.jsf.excel.ui.command.UIGroupColumns";
